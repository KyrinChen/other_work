...
$(document).ready(function(){
    ...
    var i='';
    i+='<img src="./image/tx.jpg" alt="" class="cover">';
    $('.userimg').html(i); 
});
    ...
    $.ajax({
        ...
        success:function(res){
            var i="";
                ...
                '>'+
                '<div class="imgbx">'+
                '<img src="./image/tx.jpg" alt="" class="cover">'+
                '</div>'+
                '<div class="details">'+
                '<div class="listHead">'+
                '<H4>'+
    ...
    for(var i=0;i<friendList.length;i++)
    {
        $.ajax({
            ...
            success:function(res){
                ...
                '>'+
                '<div class="imgbx">'+
                '<img src="./image/p3.png" alt="" class="cover">'+
                '</div>'+
                '<div class="details">'+
                '<div class="listHead">'+
                '<H4>'+
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            '<div class="member-info">'+
                '<p class="nick_name">'+ res.data.nick_name +'</p>'+
                '<br>'+
                '<p class="area">'+ res.data.area +'</p>'+
                '<br>'+
                '<p class="signature">'+ res.data.signature +'</p>'+
            '</div>'+
            '<div class="member-image">'+
                '<img src="./image/male.png" alt="Member">'+
            '</div>'+
            '</div>'+
...
$(document).on('click', '.block', function () {
    ...
    $('.rightSide .header .chatUser').empty();
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            '</div>';
            $('.rightSide .header .chatUser').append(i);
        },
        error:function(){
           alert("1调用失败！")
        }
